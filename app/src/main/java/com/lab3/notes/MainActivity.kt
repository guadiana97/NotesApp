...
import com.lab3.notes.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        // Action bar item clicks handled here The action bar will
        // automatically handle clicks on the Home/Up button. Need
        // to specify a parent activity in AndroidManifest.xml.
